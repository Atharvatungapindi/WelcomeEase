            ...
            <div className="relative pt-24 pb-20 container mx-auto px-4 content-center bg-opacity-50">
                <div className="text-center space-y-10 max-w-4xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl text-foreground/80">
                        Meet <span
                        className="text-transparent font-semibold bg-clip-text bg-gradient-to-r from-primary to-secondary">Stephanie</span> -
                    ...
                    <div className="mt-12 bg-opacity-50">
                        <ChatBubble message="Hi! What would like to order today?" avatar="/ollie.png"
                                    name="Stephanie"/>
                    </div>
                </div>
            </div>
